    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-slate-900 text-slate-100 flex flex-col">
            ...
            <nav class="flex-1 px-4 py-4 space-y-2 text-sm">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 px-3 py-2 rounded-md bg-slate-800">
                    <span>Tableau de bord</span>
                </a>

                {{-- Lien vers la liste des sites --}}
                <a href="{{ route('admin.sites.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-slate-800">
                    <span>Sites touristiques</span>
                </a>

                {{-- Réservations (plus tard) --}}
                ...
                <div class="bg-white shadow-sm rounded-xl">
                    <div class="p-6">
                        ...
                        <div class="flex flex-wrap gap-3 text-sm">
                            {{-- Lien vers la création d’un site --}}
