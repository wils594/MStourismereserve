...
<head>
    ...
    {{-- Si tu utilises encore Vite/Tailwind, garde ça, sinon tu peux le retirer --}}
    @vite(['resources/css/app.css', 'resources/js/app.js'])

    <style>
        /* RESET léger pour cette page */
        *, *::before, *::after {
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-panel-left">
            <div>
                ...
                <div class="hero-text">
                    <h2 class="hero-title">
                        Votre <span>espace pro</span><br>
                        pour gérer vos visites.
                    </h2>
                    <p class="hero-desc">
                        Accédez au tableau de bord, gérez les réservations, suivez les statistiques de fréquentation
                        et coordonnez les expériences touristiques en toute simplicité.
                    </p>
            ...
            <div class="hero-footer">
                <strong>Tip :</strong> gardez vos accès confidentiels.  
                Ne partagez jamais votre mot de passe avec un tiers.
            </div>
        </div>

        {{-- PANEL DROIT : FORMULAIRE LARAVEL --}}
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <label for="email" class="form-label">
                        ...
                        <span class="label-hint">Compte professionnel</span>
                    </label>
                ...
                {{-- Mot de passe --}}
                <div class="form-group">
                    <div class="form-label helper-row">
                ...
                <div class="checkbox-row">
                    ...
                    <label for="remember_me">
                        Se souvenir de cette session sur cet appareil
                    </label>
                </div>
                ...
                <div class="below-button">
                    <span>Besoin d’aide ? <strong>Contactez l’administrateur</strong></span>
                    <span>v1.0.0</span>
                </div>
    ...
    <script>
        ...
        if (passwordInput && togglePasswordBtn) {
            togglePasswordBtn.addEventListener('click', () => {
                ...
                togglePasswordBtn.textContent = type === 'password' ? 'Afficher' : 'Masquer';
            });
        }
    </script>
</body>
